...
# button
register_button = Button(root, text="Admin Register", borderwidth="10", command=admin_register, font=("Consolas 13 bold"), bg="black", fg="lightblue")
register_button.place(x=490, y=540)
